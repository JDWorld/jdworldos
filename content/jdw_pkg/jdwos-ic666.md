...
# ⚡ JÐWØ®LÐ Ø$: INFERNO CORE v6.6.6 ⚡

Inferno Core nasce come una TUI musicale e si evolve in una Plancia di Comando Unificata e Modulare.
Gestisce le diverse TUI create per il JDWorld OS

### 📦 Scheda Tecnica del Pacchetto

*   **Name**: JDWorld OS Inferno Core v6.6.6 ({{< title >}}.jdw)
...
* `kdialog`
Dal JDWOS-Repo provvederà a scaricare automaticamente le dipendenze richieste:
* `jdwos-corelib`
* `ic666-pm`
* `jdwos-nuke`
